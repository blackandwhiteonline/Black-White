...
export const products = [
  ...
  // WHITE PRODUCTS - MEN'S TOPWEAR
  {
    id: 'm-white-t-shirt-1',
  ...
  },
  {
    ...
    description: 'Comfortable white casual shirt perfect for everyday wear.',
    features: ['Cotton blend', 'Casual fit', 'Button-down collar', 'Versatile styling'],
    inStock: true,
    createdAt: '2024-01-10'
  },
  {
    id: 'm-white-formal-shirt-1',
    ...
    description: 'Professional white formal shirt for office and business meetings.',
    features: ['Premium cotton', 'Formal fit', 'Starched finish', 'Iron-free'],
    inStock: true,
    createdAt: '2024-01-05'
  },

  // WHITE PRODUCTS - WOMEN'S TOPWEAR
  {
    id: 'w-white-t-shirt-1',
    name: 'Classic White T-Shirt',
    category: 'womens-topwear',
    subcategory: 't-shirts',
    gender: 'women',
    ...
    description: 'Elegant white t-shirt for women with perfect fit.',
    features: ['100% Cotton', 'Women\'s fit', 'Comfortable', 'Versatile'],
    inStock: true,
    createdAt: '2024-01-08'
  },
  {
    id: 'w-white-casual-shirt-1',
    name: 'White Casual Shirt',
    category: 'womens-topwear',
    subcategory: 'casual-shirts',
    gender: 'women',
    ...
    description: 'Stylish white casual shirt for women.',
    features: ['Cotton blend', 'Women\'s fit', 'Casual style', 'Comfortable'],
    inStock: true,
    createdAt: '2024-01-12'
  },

  // WHITE PRODUCTS - BOTTOMWEAR
  {
    id: 'm-white-jeans-1',
    ...
    description: 'Classic white denim jeans for men.',
    features: ['100% Cotton', 'Denim fabric', 'Classic fit', 'Durable'],
    inStock: true,
    createdAt: '2024-01-20'
  },
  {
    ...
    description: 'Stylish white denim jeans for women.',
    features: ['100% Cotton', 'Women\'s fit', 'Denim fabric', 'Comfortable'],
    inStock: true,
    createdAt: '2024-01-22'
  }
];
